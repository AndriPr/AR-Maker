...
export const useEditorStore = create<EditorState>((set, get) => ({
  ...
  setIsTransforming: (val: boolean) => set(state => { if (!val) return { isTransforming: val, lastTransformEndTime: performance.now() }; return { isTransforming: val }; }),
